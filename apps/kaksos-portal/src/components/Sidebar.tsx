...
const NAV_ITEMS: NavItem[] = [
    // DEPRECATED: Conversations page removed from nav - uses legacy kaksos_conversations table
    // Plant Seeds already has its own conversation list, making this redundant.
    // {
    //     label: 'Conversations',
    //     path: '/conversations',
    //     icon: (
    ...
    return (
        ...
        >
            ...
            <div className="h-16 flex items-center justify-between px-4 border-b border-gray-200">
                ...
                <button
                    onClick={onClose}
                    className="md:hidden min-h-[44px] min-w-[44px] flex items-center justify-center -mr-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-colors"
                ...
                <ul className="space-y-1 px-3">
                    ...
                    <li>
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                `flex items-center gap-3 px-3 py-3 md:py-2.5 rounded-lg text-sm font-medium transition-colors ${isActive
            ...
            <div className="border-t border-gray-200 p-4">
                <div className="flex items-center gap-3">
                    ...
                    <button
                        onClick={logout}
                        className="min-h-[44px] min-w-[44px] flex items-center justify-center text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition-colors"
                        title="Sign out"
                    >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
