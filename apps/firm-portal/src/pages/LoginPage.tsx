        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-amber-50 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    />
                    <h1 className="text-xl font-semibold text-gray-800">Firm Portal</h1>
                    <p className="text-gray-500 text-sm">Manage your security firm</p>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div className="mt-6 pt-4 border-t border-gray-100 text-center">
                        <p className="text-sm text-gray-500 mb-3">
                            This portal is for registered security firms only.
                        </p>
                        <a
